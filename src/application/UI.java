...
public class UI { // User Interface = Interface de Usuário
	...
	//codigos para as cores e imprimir no console
	//cores texto
	...
	public static ChessPosition readChessPosition(Scanner sc) {
		try {
			...
			int row = Integer.parseInt(s.substring(1)); // recortar meu string a partir da posição 1 e vou converter o resultado para inteiro
	...
	public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
		...
		printCapturedPieces(captured); // print das peças capturadas
		System.out.println();
